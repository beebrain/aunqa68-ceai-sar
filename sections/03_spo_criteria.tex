...
\begin{tabularx}{\linewidth}{|c|>{\raggedright\arraybackslash}X|c|}
    ...
    \hline
    1 & Expected Learning Outcomes & 2 \\
    \hline
    2 & Programme Structure and Content & 2 \\
    \hline
    3 & Teaching and Learning Approach & 2 \\
    \hline
    4 & Student Assessment & 2 \\
    \hline
    5 & Academic Staff Quality & 2 \\
    \hline
    6 & Student Support Services & 2 \\
    \hline
    7 & Facilities and Infrastructure & 2 \\
    \hline
    8 & Output, Outcomes and Impact & 2 \\
    \hline
    \textbf{รวมเฉลี่ย} & & \textbf{2.00} \\
    \hline
\end{tabularx}
